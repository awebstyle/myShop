        ...
        <ul class="slides-container">
            @foreach($sliders as $slider)
                <li class="text-center">
                    <img src="{{ asset('storage/sliders-images/'. $slider->image) }}" alt="{{ $slider->description1 }}">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                    ...
                    <div class="col-lg-3 col-md-6 special-grid best-seller">
                        <div class="products-single fix">
                            <div class="box-img-hover">
                                ...
                                <img src="{{ asset('storage/products-images/' . $product->product_image)}}" class="img-fluid" alt="Image">
                                <div class="mask-icon">
                                    <ul>
