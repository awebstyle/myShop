              ...
              <form action="{{route('updateslider', [$slider->id])}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" required name="description1" class="form-control" id="exampleInputEmail1" value={{ $slider->description1 }}>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Slider description 2</label>
                    <input type="text" required name="description2" class="form-control" id="exampleInputEmail1" value={{ $slider->description2 }}>
                  </div>
